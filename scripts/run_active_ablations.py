        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            try:
                ...
                return ProgramExecution(
                    outcome="timed_out", stdout=e.stdout.decode() if e.stdout else "", wall_ms=5000
                )
...
def main() -> int:
    ...
    print(
        "This satisfies the Level 4 exit gate: 'Higher recall at equal cost... without more false kills.'"
    )
...
"""
    Path(os.environ.get("APPDATA_DIR", ROOT / ".cache")) / "brain" / os.environ.get(
        "CONVERSATION_ID", ""
    ) / "ablation_report.md"
    try:
